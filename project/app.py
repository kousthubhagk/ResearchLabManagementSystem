...
if state["is_logged_in"]:
    ...
    # Continue with the rest of the application for other user types
        ...
        if lab_personnel:
            ...
            pending_proposals_query = f"SELECT * FROM ProjectProposal WHERE LabID = '{state['lab_id']}' AND TeacherApprovedStatus = 'not approved';"
            ...
            if pending_proposals:
                ...
                for proposal in pending_proposals:
                    st.write(f"Proposal ID: {proposal[0]}, Title: {proposal[1]}, Description: {proposal[2]}, Student ID: {proposal[8]}")
